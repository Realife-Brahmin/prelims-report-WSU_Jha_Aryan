...
\begin{ganttchart}[
    ...
    bar label node/.append style={align=left, text width=10cm},
]{1}{9}
    % Timeline labels
    ...
    \ganttbar[bar/.append style={fill=blue!40}]{Implementing tADMM for 1-ph Systems (IEEE 123)}{1}{3} \\
    \ganttbar[bar/.append style={fill=white, draw=black}]{Formulation Development}{1}{2} \\
    \ganttbar[bar/.append style={fill=gray!60}]{Implementation for T=24, 96}{2}{3} \\
    
    % Spring 2026 Task
    \ganttgroup[group/.append style={fill=green!30}]{Task 2: Spatial Decomposition for Large 3-ph Systems}{3}{6} \\
    \ganttbar[bar/.append style={fill=green!40}]{Expanding to 3-ph Systems (IEEE 9500)}{3}{6} \\
    \ganttbar[bar/.append style={fill=white, draw=black}]{Formulation Development}{3}{4} \\
    \ganttbar[bar/.append style={fill=orange!40}]{Decomposition Methods}{4}{5} \\
    \ganttbar[bar/.append style={fill=gray!60}]{Implementation and Testing}{5}{6} \\
    
    % DDP Research
    \ganttgroup[group/.append style={fill=purple!30}]{Task 3: Differential Dynamic Programming}{5}{7} \\
    \ganttbar[bar/.append style={fill=purple!40}]{DDP Research and Implementation}{5}{7} \\
    \ganttbar[bar/.append style={fill=white, draw=black}]{Literature Review}{5}{6} \\
    \ganttbar[bar/.append style={fill=black!60}]{Formulation and Testing}{6}{7} \\
