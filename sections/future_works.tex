...
\begin{ganttchart}[
    ...
    % Task 2
    \ganttgroup[group/.append style={fill=green!30}]{Task 2: Temporal Decomposition for Large 3-ph Systems}{3}{6} \\
    \ganttbar[bar/.append style={fill=white, draw=black}]{Formulation}{3}{4} \\
    \ganttbar[bar/.append style={fill=green!50}]{Implementation and Testing on IEEE 9500, 3-ph}{4}{6} \\
    
    % Task 3
    \ganttgroup[group/.append style={fill=orange!30}]{Task 3: Concluding Research and Dissertation}{5}{9} \\
    \ganttbar[bar/.append style={fill=pink!50}]{Finishing DDP Investigation}{5}{6} \\
    \ganttbar[bar/.append style={fill=purple!40}]{Literature Review on Temporal Decomposition Methods}{6}{7} \\
    \ganttbar[bar/.append style={fill=orange!50}]{Remaining Implementations}{6}{7} \\
