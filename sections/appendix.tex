...
In \Cref{subsec:full-mpopf-lindistflow} from \Crefrange{eq:objfun-cost-of-substation-power-ldf}{eq:pv-reactive-limits-ldf}, the full optimization formulation for the Multi-Period Optimal Power Flow (MPOPF) problem using the LinDistFlow model is presented.
